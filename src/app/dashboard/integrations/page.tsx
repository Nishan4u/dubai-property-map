...
import { getCrmIntegrationsForOwner, requireDeveloperProfile } from "@/lib/supabase/queries";

export const dynamic = "force-dynamic";

export default async function DeveloperIntegrationsPage() {
  const profile = await requireDeveloperProfile();
  const integrations = await getCrmIntegrationsForOwner("developer", profile.developer_id);

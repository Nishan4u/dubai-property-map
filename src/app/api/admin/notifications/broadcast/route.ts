...
export async function POST(request: NextRequest) {
  ...
  if (!hasModuleAccess(permissionProfile, permissions, "notifications", "manage")) {
    return NextResponse.json({ error: "You don't have permission to manage notifications." }, { status: 403 });
  }

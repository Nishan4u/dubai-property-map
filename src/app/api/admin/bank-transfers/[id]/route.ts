...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (!hasModuleAccess(permissionProfile, permissions, "bank-transfers", "manage")) {
    return NextResponse.json({ error: "You don't have permission to manage bank transfers." }, { status: 403 });
  }

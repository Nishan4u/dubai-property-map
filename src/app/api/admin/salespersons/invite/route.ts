...
export async function POST(request: NextRequest) {
  ...
  if (!hasModuleAccess(permissionProfile, permissions, "salespersons", "manage")) {
    return NextResponse.json({ error: "You don't have permission to manage salespersons." }, { status: 403 });
  }

...
// Deliberately its own component, not shared with the salesperson/
// developer portals -- matches this codebase's established convention
// of keeping broker/salesperson/developer business components separate
// even when near-identical.
export function BrokerCollectionsClient({
  brokerId,

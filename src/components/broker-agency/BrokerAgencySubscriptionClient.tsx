...
export function BrokerAgencySubscriptionClient({
  plans,
  currentPlanKey,
  subscriptionStatus,
  ...
  async function handleSubscribe(plan: string) {
    ...
    setError("");
    try {
      const res = await fetch("/api/broker-agency/stripe/checkout", {
        method: "POST",
  ...
  async function handleManageBilling() {
    ...
    setError("");
    try {
      const res = await fetch("/api/broker-agency/stripe/portal", { method: "POST" });
      const data = await res.json();

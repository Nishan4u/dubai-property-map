...
// Mirrors src/components/broker/BrokerClientDetailClient.tsx -- see it for
...
export function SalespersonClientDetailClient({
  ...
  return (
    <div className="space-y-4">
      ...
      <Link href="/salesperson/clients" className="inline-block text-xs text-ink-500 hover:text-ink-300">
        ← Back to Clients
      </Link>
    </div>
  );

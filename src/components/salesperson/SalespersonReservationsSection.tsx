...
// Mirrors src/components/broker/BrokerReservationsSection.tsx -- see it
// for context. Kept as its own copy rather than a shared component since
// broker/salesperson portals are otherwise fully separate component
// trees in this codebase.
export function SalespersonReservationsSection({
  clientId,

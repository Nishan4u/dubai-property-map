...
export const communities: Community[] = [
  { id: "com-palm", slug: "palm-jumeirah", name: "Palm Jumeirah", description: "Iconic man-made island with beachfront villas and branded residences.", projectsCount: 12, avgPriceAed: 4200000, priceTrendPct: 8.2, xPct: 9, yPct: 30, lng: 55.1385, lat: 25.1124, pinColor: "#3b82f6" },
  { id: "com-marina", slug: "dubai-marina", name: "Dubai Marina", description: "High-rise waterfront living with a bustling promenade and marina walk.", projectsCount: 18, avgPriceAed: 1900000, priceTrendPct: 5.4, xPct: 21, yPct: 36, lng: 55.1400, lat: 25.0805, pinColor: "#eab308" },
  { id: "com-jlt", slug: "jumeirah-lakes-towers", name: "Jumeirah Lakes Towers", description: "Mixed-use lake-front towers close to Dubai Marina and JBR.", projectsCount: 18, avgPriceAed: 1200000, priceTrendPct: 4.1, xPct: 25, yPct: 46, lng: 55.1420, lat: 25.0693, pinColor: "#22c55e" },
  { id: "com-jvc", slug: "jumeirah-village-circle", name: "Jumeirah Village Circle", description: "Family-friendly circular community with parks and affordable apartments.", projectsCount: 11, avgPriceAed: 850000, priceTrendPct: 6.7, xPct: 17, yPct: 58, lng: 55.2080, lat: 25.0596, pinColor: "#f97316" },
  { id: "com-motorcity", slug: "motor-city", name: "Motor City", description: "Motorsport-themed community with low-rise apartments and townhouses.", projectsCount: 8, avgPriceAed: 780000, priceTrendPct: 3.2, xPct: 23, yPct: 68, lng: 55.2400, lat: 25.0470, pinColor: "#3b82f6" },
  { id: "com-dubai-south", slug: "dubai-south", name: "Dubai South", description: "Airport-district master plan anchored by Al Maktoum International and Expo City.", projectsCount: 14, avgPriceAed: 690000, priceTrendPct: 9.8, xPct: 13, yPct: 82, lng: 55.1700, lat: 24.8970, pinColor: "#a855f7" },
  { id: "com-bay", slug: "business-bay", name: "Business Bay", description: "Dubai's business and lifestyle hub along the Dubai Water Canal.", projectsCount: 34, avgPriceAed: 1650000, priceTrendPct: 7.1, xPct: 45, yPct: 37, lng: 55.2708, lat: 25.1857, pinColor: "#22c55e" },
  { id: "com-downtown", slug: "downtown-dubai", name: "Downtown Dubai", description: "Home to Burj Khalifa, Dubai Mall and Dubai Fountain — the city's premium core.", projectsCount: 25, avgPriceAed: 2800000, priceTrendPct: 6.3, xPct: 53, yPct: 27, lng: 55.2744, lat: 25.1972, pinColor: "#ef4444" },
  { id: "com-creek", slug: "dubai-creek-harbour", name: "Dubai Creek Harbour", description: "Waterfront master plan facing Ras Al Khor, future home of Dubai Creek Tower.", projectsCount: 11, avgPriceAed: 1750000, priceTrendPct: 10.4, xPct: 69, yPct: 13, lng: 55.3467, lat: 25.1950, pinColor: "#3b82f6" },
  { id: "com-arjan", slug: "arjan", name: "Arjan", description: "Emerging affordable community near Dubai Miracle Garden.", projectsCount: 8, avgPriceAed: 720000, priceTrendPct: 5.9, xPct: 47, yPct: 58, lng: 55.2460, lat: 25.0630, pinColor: "#eab308" },
  { id: "com-damac-hills", slug: "damac-hills", name: "DAMAC Hills", description: "Golf-course community with villas, townhouses and Trump International Golf Club.", projectsCount: 13, avgPriceAed: 2100000, priceTrendPct: 4.8, xPct: 60, yPct: 58, lng: 55.2530, lat: 25.0290, pinColor: "#22c55e" },
  { id: "com-damac-hills-2", slug: "damac-hills-2", name: "DAMAC Hills 2", description: "Affordable family villas and townhouses further along Al Qudra Road.", projectsCount: 10, avgPriceAed: 1100000, priceTrendPct: 6.1, xPct: 67, yPct: 67, lng: 55.2200, lat: 24.9950, pinColor: "#a855f7" },
  { id: "com-hills", slug: "dubai-hills-estate", name: "Dubai Hills Estate", description: "Green master community with Dubai Hills Mall and championship golf course.", projectsCount: 15, avgPriceAed: 2400000, priceTrendPct: 7.8, xPct: 74, yPct: 37, lng: 55.2470, lat: 25.1050, pinColor: "#f97316" },
  { id: "com-meydan", slug: "meydan", name: "Meydan", description: "Home to Meydan Racecourse, canal-front villas and new golf residences.", projectsCount: 17, avgPriceAed: 3100000, priceTrendPct: 9.1, xPct: 79, yPct: 52, lng: 55.3050, lat: 25.1560, pinColor: "#3b82f6" },
];
